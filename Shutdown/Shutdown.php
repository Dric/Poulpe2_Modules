		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="alert alert-danger">
					...
					<ol>
						<li>Déplacez les fichiers <code>shutdown_suid</code> et <code>reboot_suid</code> dans <code>/usr/local/bin</code> : <br><code>sudo mv <?php echo Front::getAbsolutePath(); ?>/<?php echo \Settings::MODULE_DIR; ?>/Shutdown/*_suid /usr/local/bin</code></li>
